...
public class Constants {
    ...
    public static final String CARD_NUMBER = "2222 3333 4444 5555";
    public static final String CARD_NUMBER_NO_MONEY = "0000 4444 5555 6666";
    public static final String CARD_NAME = "JOHN HENRY";
    public static final String CARD_NAME_NO_MONEY = "MR SMITH";
    public static final String EXPIRY_DATE = "12/25";
