...
public class Constants {
    ...
    public static final String VALID_CARD_NUMBER = "2222 3333 4444 5555";
    public static final String INVALID_CARD_NUMBER = "2222 3333 4444";
    public static final String VALID_CARD_NAME = "JOHN HENRY";
